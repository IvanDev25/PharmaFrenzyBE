...
namespace Api.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        private const string DefaultDailyStreakLinuxTimeZoneId = "Asia/Singapore";
        ...
        {
            var requestedTimeZoneIds = new List<string>();

            if (!string.IsNullOrWhiteSpace(configuredTimeZoneId))
            {
                requestedTimeZoneIds.Add(configuredTimeZoneId.Trim());
            }

            requestedTimeZoneIds.Add(DefaultDailyStreakTimeZoneId);
            requestedTimeZoneIds.Add(DefaultDailyStreakLinuxTimeZoneId);

            foreach (var timeZoneId in requestedTimeZoneIds.Distinct(StringComparer.OrdinalIgnoreCase))
            {
                try
                {
